...
const TitleBar = () => {
  return <div className='flex justify-between items-center bg-[#121212] h-[35px] px-6 border border-b-borderColor border-t-transparent border-l-transparent border-r-transparent'>
